...
const UP_PROFILE_RULES: Array<UpCategoryMatch & { keywords: RegExp }> = [
  { l1: "计算机", l2: "前端", keywords: /前端开发|up主.*前端/i },
  {
    l1: "计算机",
    l2: "嵌入式",
    keywords: /嵌入式|单片机|stm32|arduino|fpga|rtos|物联网|mcu/i,
  },
  {
    l1: "计算机",
    l2: "硬核科技",
    keywords: /硬核科技|硬核|芯片|半导体|光刻|处理器|硬件/i,
  },
  ...
  { l1: "生活", l2: "财经", keywords: /股票投资|财经|基金/i },
  {
    l1: "生活",
    l2: "历史人文",
    keywords: /历史人文|社会人文|历史|人文|哲学|考古|女权|时评/i,
  },
...
function matchRules(
  text: string,
  rules: Array<UpCategoryMatch & { keywords: RegExp }>,
...
export function classifyUpFromVideoTitles(
  titles: string[],
): UpCategoryMatch | null {
